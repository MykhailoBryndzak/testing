...
export class PreAdmitStore {
    ...
    constructor(private preAdmitService: PreAdmitService) {
    }
    ...
    updateInputField(fieldName: string, value: any, currentPreAdmitId: string): void {
        this.preAdmit[currentPreAdmitId][fieldName] = value;
        console.info(   this.preAdmit[currentPreAdmitId][fieldName] );
    }
}
